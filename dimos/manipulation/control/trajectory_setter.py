...
class TrajectorySetter:
    ...
    def __init__(self, arm_type: str = "xarm"):
        ...
        Args:
            arm_type: Type of arm ("xarm", "piper", "lerobot", etc.)
        """
        self.arm_type = arm_type.lower()

        # Publisher for trajectories
        trajectory_topic = "/lerobot/trajectory" if self.arm_type == "lerobot" else "/trajectory"
        self.trajectory_pub = core.LCMTransport(trajectory_topic, JointTrajectory)
        ...
        print(f"  Publishing to: {trajectory_topic}")
