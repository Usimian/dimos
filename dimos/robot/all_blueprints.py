...
all_blueprints = {
    ...
    # LeRobot SO-ARM101 manipulator blueprints
    "so-arm101-servo": "dimos.hardware.manipulators.lerobot.so_arm101_blueprints:so_arm101_servo",
    "so-arm101-trajectory": "dimos.hardware.manipulators.lerobot.so_arm101_blueprints:so_arm101_trajectory",
    # Demo blueprints
...
all_modules = {
    ...
    # LeRobot manipulator modules
    "so_arm101_driver": "dimos.hardware.manipulators.lerobot.so_arm101_driver",
}
